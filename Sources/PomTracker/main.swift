...
// Saving fixtures
saveData(areas, to: "areas.json")
saveData(projects, to: "projects.json")
saveData(tasks, to: "tasks.json")
saveData(pomodoros, to: "pomodoros.json")

// Loading fixtures
let loadedAreas: [Area]? = loadData(from: "areas.json")
let loadedProjects: [Project]? = loadData(from: "projects.json")
let loadedTasks: [Task]? = loadData(from: "tasks.json")
let loadedPomodoros: [Pomodoro]? = loadData(from: "pomodoros.json")

print(loadedAreas ?? "No area loaded")
